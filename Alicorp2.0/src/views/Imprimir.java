...
public void cargarDatosUsuario(UsuariosDto dto) {
...
private void LimpiarTable() {
 ...
 private void ListarProductos() {
        ...
        try {
            List<ProductosDTO> Listar = productosDao.Listartodo();
            Object[] fila = new Object[4]; // Ajusta el número según las columnas de tu tabla
            for (int i = 0; i < Listar.size(); i++) {
                fila[0] = Listar.get(i).getNombreProducto()+"\n"+Listar.get(i).getPeso()+"\n"+Listar.get(i).getPrecio();
                fila[1]= Listar.get(i).getAlmacen();
                fila[2] = Listar.get(i).getStock();
                fila[3] = Listar.get(i).getFechaCaducidad();               
                 // Asegúrate de que esto devuelva un byte[]
                modelo.addRow(fila);
            }
        } catch (Exception e) {
            e.printStackTrace();
